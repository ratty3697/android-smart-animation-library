...
public class AttentionView extends AppCompatActivity {
    ...
    public void animationStart(View v){
        ...
        if(v.getId() == (R.id.bounce)){
            StartSmartAnimation.startAnimation(findViewById(R.id.bounce), AnimationType.Bounce, 2000 ,0 , false);
        }
        else if(v.getId() == (R.id.flash)){
            StartSmartAnimation.startAnimation(v, AnimationType.Flash, 2000 , 0 ,false);
        }
            ...
            StartSmartAnimation.startAnimation(v, AnimationType.Wave, 2000 , 0 ,false);
        }
        else if(v.getId() == (R.id.wobble)){
            StartSmartAnimation.startAnimation(v, AnimationType.Wobble, 2000 , 0 ,false);
        }
    }
}
