...
public class SpecialView extends AppCompatActivity {
    ...
    public void animationStart(View v){
        ...
        if(v.getId() == (R.id.drop_out)){
            StartSmartAnimation.startAnimation(v, AnimationType.DropOut, 2000, 0, 100);
        }
        else if(v.getId() == (R.id.landing)){
            StartSmartAnimation.startAnimation(v, AnimationType.Landing, 2000 , 0 , 100);
        }
        else if(v.getId() == (R.id.taking_off)){
            StartSmartAnimation.startAnimation(v, AnimationType.TakingOff, 2000 , 0 , 100);
        }
        else if(v.getId() == (R.id.hinge)){
            StartSmartAnimation.startAnimation(v, AnimationType.Hinge, 2000 , 0 , 100);
        }
        else if(v.getId() == (R.id.roll_in)){
            StartSmartAnimation.startAnimation(v, AnimationType.RollIn, 2000 , 0 , 100);
        }
        else if(v.getId() == (R.id.roll_out)){
            StartSmartAnimation.startAnimation(v, AnimationType.RollOut, 2000 , 0 , 100);
        }
    }
}
