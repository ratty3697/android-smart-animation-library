...
public class FadeOutView extends AppCompatActivity {
    ...
    public void animationStart(View v){
        ...
        if(v.getId() == (R.id.fade_out)){
            StartSmartAnimation.startAnimation(v, AnimationType.FadeOut, 1000, 0, true,100);
        }
        else if(v.getId() == (R.id.fade_out_down)){
            StartSmartAnimation.startAnimation(v, AnimationType.FadeOutDown, 1000,0,true,100);
        }
        else if(v.getId() == (R.id.fade_out_left)){
            StartSmartAnimation.startAnimation(v, AnimationType.FadeOutLeft, 1000,0,true,100);
        }
        else if(v.getId() == (R.id.fade_out_right)){
            StartSmartAnimation.startAnimation(v, AnimationType.FadeOutRight, 1000,0,true,100);
        }
        else if(v.getId() == (R.id.fade_out_up)){
            StartSmartAnimation.startAnimation(v, AnimationType.FadeOutUp, 1000,0,true,100);
        }
