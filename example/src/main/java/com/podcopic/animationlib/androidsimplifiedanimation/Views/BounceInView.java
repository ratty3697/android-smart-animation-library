...
public class BounceInView extends AppCompatActivity {
    ...
    public void animationStart(View v){
        ...
        if(v.getId() == (R.id.bounce_in)){
            StartSmartAnimation.startAnimation(v, AnimationType.BounceIn, 1000,0,100);
        }
        else if(v.getId() == (R.id.bounce_in_down)){
            StartSmartAnimation.startAnimation(v, AnimationType.BounceInDown, 1000,0,100);
        }
        else if(v.getId() == (R.id.bounce_in_left)){
            StartSmartAnimation.startAnimation(v, AnimationType.BounceInLeft, 1000,0,100);
        }
        else if(v.getId() == (R.id.bounce_in_right)){
            StartSmartAnimation.startAnimation(v, AnimationType.BounceInRight, 1000,0,100);
        }
        else if(v.getId() == (R.id.bounce_in_up)){
            StartSmartAnimation.startAnimation(v, AnimationType.BounceInUp, 1000,0,100);
        }
